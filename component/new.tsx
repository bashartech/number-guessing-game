...
export default function NumberGuessing(): JSX.Element {
  ...
  return (
    <div className="container flex flex-col items-center justify-center h-screen bg-gradient-to-br from-gray-800 to-black">
      {/* Main container for the game */}
      <div className="game-box bg-white rounded-lg shadow-lg p-8 w-full max-w-md">
        {/* Title of the game */}
        <h1 className="game-title text-3xl font-bold text-center mb-2 text-black">
          Number Guessing Game
        </h1>
        {/* Description of the game */}
        <p className="game-description text-center text-black mb-4">
        ...
        {!gameStarted && (
          <div className="button-container flex justify-center mb-4">
            ...
            <Button
              ...
              className="start-btn btn bg-black hover:bg-gray-700 text-white font-bold py-2 px-4 rounded"
            >
              Start Game
            </Button>
          </div>
        ...
        {gameStarted && !gameOver && (
          <div>
            <div className="flex justify-center mb-4">
              ...
              {paused ? (
                <Button
                  ...
                  className="btn resume-btn bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded"
                >
                  Resume
                </Button>
              ) : (
                ...
                <Button
                  ...
                  className="btn pause-btn bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded"
                >
                  Pause
                </Button>
              )}
            ...
            <div className="input-container flex justify-center mb-4">
              ...
              <Button
                onClick={handleGuess}
                className="btn guess-btn bg-gray-700 hover:bg-gray-800 text-white font-bold py-2 px-4 rounded ml-4"
              >
                Guess
              </Button>
            </div>
        ...
        {gameOver && (
          <div>
            <div className=" game-over text-center mb-4 text-black">
              {/* Game over message */}
              <h2 className="game-over-title text-2xl font-bold">Game Over!</h2>
            ...
            <div className="flex justify-center">
              ...
              <Button
                ...
                className="btn try-again-btn bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded"
              >
                Try Again
              </Button>
            </div>
